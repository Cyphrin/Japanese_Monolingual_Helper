...
def getSynonym(synonym):
	...
	# The first set of loops Grabs all the words that aren't in "a" tags and put them in the list
	...
	# The second set of loops grabs all the words that are in "a" tags and puts them in the list
